<template>
    <footer class="w-full bg-black">
        <div class="max-w-7xl mx-auto pt-11 pb-14 md:pt-11 md:pb-24 px-2 md:px-0 border-t border-gray-300 flex flex-col md:flex-row items-center justify-start md:justify-between">
